...
function isNumeric(value) {
	...
	if(validateString(fname)&&validateString(lname)&&validateString(uname)&&validateString(pwd)&&validateString(email)&&validateString(phoneno))
	{
	 return true;
	}
else
			...
			<table>
				<tbody><tr>
					...
					<table align="right" cellpadding="2">
						<tbody><tr>
							<td width="90">
							<div id="menu" align="center"><a href="<jstlcore:url value="check.htm"/>">
							Login_Page </a></div>
							</td>							
						</tr>
					</tbody></table>
				...
				<tr>
					...
					<table align="center" border="0">
					   ...
					   <tr>
                           <td><span style="font-weight: bold;color: red;font-size: 15px;">*</span>
                           Phone Number:</td><td><input type="text" name="PHONENO" size="25" maxlength="40"></input></td>
